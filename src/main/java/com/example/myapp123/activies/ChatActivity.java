...
import com.example.myapp123.adapters.ChatAdapter;
import com.example.myapp123.databinding.ActivityChatBinding;
import com.example.myapp123.models.ChatMessage;
import com.example.myapp123.models.User;
import com.example.myapp123.network.ApiClient;
import com.example.myapp123.network.ApiService;
...
private void listenAvailabilityOfReceiver(){
    ...
    private void addConversion(HashMap<String,Object>conversion){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                .add(conversion).addOnSuccessListener(documentReference -> conversionID=documentReference.getId());
    }
