...
import com.example.myapp123.databinding.ActivitySignUpactivityBinding;
...
public class SignUpActivity<uri> extends AppCompatActivity {
...
private String encodedImage;
    ...
    private final ActivityResultLauncher<Intent>pickImage=registerForActivityResult(
            new ActivityResultContracts.StartActivityForResult(),resut ->{
                if (resut.getResultCode()==RESULT_OK){
                    if (resut.getData()!=null){
                        Uri imageUri=resut.getData().getData();
                        try {
